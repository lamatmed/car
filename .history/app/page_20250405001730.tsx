...
export default function Home() {
  ...
  const fetchData = async () => {
    setLoading(true);
    const params = {
      manufacturer: searchParams.get('manufacturer') || 'toyota',  // Default value
      year: Number(searchParams.get('year')) || 2022,
      fuel: searchParams.get('fuel') || 'gas',  // Default value
      limit: Number(searchParams.get('limit')) || 10, // Limit value
      model: searchParams.get('model') || 'corolla',  // Default value
    };
